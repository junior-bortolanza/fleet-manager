...
import com.bortolanza.fleet.common.exceptions.dto.ErrorResponseDTO;
...
public class AuthFilter extends OncePerRequestFilter {
    ...
    public AuthFilter(TokenUtil tokenUtil, UserDetailsService userDetailsService) {
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                ...
                final String username = tokenUtil.extractEmailToken(token);
            ...
            response.getWriter().write(buildErrorMessage(HttpStatus.UNAUTHORIZED.value(),
                    "Expired token",
    ...
    private String buildErrorMessage(int status, String message, String path, String error) {
